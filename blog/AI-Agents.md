...
## Table of Contents
0. Thoughts on AI/AI Agents in general
1. Where I started
2. The Work Unit system
3. Transition to OpenClaw
4. Future work
...
Yes, I do rely on an LLM every day (!) to devise what I'm doing for the day, but I can still reconstruct that same information later. I know exactly what's going into the LLM as inputs and what's coming out as outputs. I believe AI is the next great equaliser in assistive technology. I use AI to make many things easier on myself, that I can do myself, but choose not to because of the immense emotional or cognitive load that it possesses.

# Where I started

# The Work Unit System
For a further explanation of how the system works, feel free to see [my blog post on the topic](Work-Units.md). 
