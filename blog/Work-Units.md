...
[^3]: My personal implementation of the Work Unit has other bonuses and stacking modifiers calculated daily. That implementation is not going to be brought into this post, since it would detract from the generalized explanation. Full spec sheet of my specific implementation is available [here](Work-Units-2.md).
